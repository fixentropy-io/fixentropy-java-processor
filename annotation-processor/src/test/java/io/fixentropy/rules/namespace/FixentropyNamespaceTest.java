...
public class FixentropyNamespaceTest {

    private static final Path SOURCE_FOLDER = Path.of("io", "fixentropy", "rules", "namespace");
    private static final Path OUTPUT_FOLDER = Path.of("io", "fixentropy", "rules", "namespace");
