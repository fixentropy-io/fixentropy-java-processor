...
public class RelationTest {
    ...
    private static final Path SOURCE_FOLDER = Path.of("io", "fixentropy", "rules", "relation");
    private static final Path OUTPUT_FOLDER = Path.of("io", "fixentropy", "rules", "relation");
    ...
    class Name {
        ...
        void name_of_dragee() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.name")
                    .isString()
                    .isEqualTo("io.fixentropy.rules.relation.DrageeOne");
        }
    }
    ...
    class FieldRelation {
        ...
        void direct_object() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.fixentropy.rules.relation.DrageeTwo']")
                    .isArray()
                    .contains("field");
        }
        ...
        void generic_type() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.fixentropy.rules.relation.DrageeFive']")
                    .isArray()
                    .contains("field");
        }
    }
    ...
    class ConstructorRelation {
        ...
        void generic_type() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.fixentropy.rules.relation.DrageeThree']")
                    .isArray()
                    .contains("constructor");
        }
    }
    ...
    class MethodParamRelation {
        ...
        void is_omitted_when_method_is_private() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.fixentropy.rules.relation.DrageeSeven']")
                    .isAbsent();
        }
    }
    ...
    class MethodReturnRelation {
        ...
        void direct_object() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.fixentropy.rules.relation.DrageeFour']")
                    .isArray()
        ...
        void is_omitted_when_method_is_private() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.fixentropy.rules.relation.DrageeSix']")
                    .isAbsent();
        }
    }
    ...
    class NonFixentropyTest {
        ...
        void only_dragee_are_kept() {
            ...
            assertThatJson(actualContent)
                    ...
                    .isObject()
                    .containsOnlyKeys(
                            "io.fixentropy.rules.relation.DrageeTwo",
                            "io.fixentropy.rules.relation.DrageeThree",
                            "io.fixentropy.rules.relation.DrageeFour",
                            "io.fixentropy.rules.relation.DrageeFive");
        }
    }
}
