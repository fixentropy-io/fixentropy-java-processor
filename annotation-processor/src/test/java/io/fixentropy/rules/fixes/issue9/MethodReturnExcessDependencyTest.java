...
class MethodReturnExcessDependencyTest {
    ...
    private static final Path SOURCE_FOLDER = Path.of("io", "fixentropy", "rules", "fixes", "issue9");
    private static final Path OUTPUT_FOLDER = Path.of("io", "fixentropy", "rules", "fixes", "issue9");
    ...
    void dragee_child_must_not_have_parent_on_dependency_when_name_contains_parent_name() {
        ...
        assertThatJson(actualChildContent)
                ...
                .isObject()
                .containsOnlyKeys(
                        "io.fixentropy.rules.fixes.issue9.TestId");
    }
}
