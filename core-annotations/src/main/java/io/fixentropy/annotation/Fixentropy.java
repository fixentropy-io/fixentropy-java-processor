 ...
 * It can be extended by creating annotations that are annotated with {@link Fixentropy.Namespace} and then by annotating classes.
 *
 * <pre>
 *  {@code
