...
public class DDDAnnotationsTest {
    ...
    private static final Path SOURCE_FOLDER = Path.of("io", "fixentropy", "annotation", "ddd", "sample");
    private static final Path OUTPUT_FOLDER = Path.of("io", "fixentropy", "annotation", "ddd", "sample");
